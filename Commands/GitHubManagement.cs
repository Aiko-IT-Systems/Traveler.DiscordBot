...
internal class GitHubManagement : ApplicationCommandsModule
{
	...
	)
	{
		...
		var api_endpoint = "https://api.github.com/repos/Aiko-IT-Systems/Traveler/actions/workflows/steam_deploy.yml/dispatches";
		HttpClient rest = new();
	...
	private static readonly List<string> s_fuckedGifs = new()
	{
